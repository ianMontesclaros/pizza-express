...
function Button({ children, disabled, to, type, onClick }) {
  const base =
    "inline-block text-sm rounded-full bg-orange-300 font-semibold uppercase tracking-wide text-stone-800 transition-colors duration-300 hover:bg-orange-200 focus:bg-orange-400 focus:outline-none disabled:cursor-not-allowed";
